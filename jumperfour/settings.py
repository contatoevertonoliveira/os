"""
Django settings for jumperfour project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-5*fx=)er&%b%7jwvzxsoizfs+4_z%&)*3!)b5=m=f_bmy1hh)3')
...
MIDDLEWARE = [
    ...
    'tickets.middleware.EnsureUserProfileMiddleware',
...
WSGI_APPLICATION = 'jumperfour.wsgi.application'
